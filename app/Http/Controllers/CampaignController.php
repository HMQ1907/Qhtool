...
class CampaignController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'product_price' => 'nullable|string|max:80',
            'product_pain_points' => 'nullable|string|max:1500',
            'product_reviews' => 'nullable|string|max:2000',
            'commission_rate' => 'nullable|string|max:80',
        ...
        for ($i = 0; $i < $totalVideos; $i++) {
            ...
            $video = $campaign->videos()->create([
                ...
                'product_pain_points' => $validated['product_pain_points'] ?? null,
                'product_reviews' => $validated['product_reviews'] ?? null,
